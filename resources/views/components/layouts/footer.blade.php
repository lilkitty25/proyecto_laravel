<footer class="bg-gradient-to-r from-pink-400 via-pink-500 to-red-500 text-neutral-content p-4 shadow-lg mt-4">
    <aside class="grid-flow-col items-center gap-4 hover:scale-105 transition-all duration-300">
        <svg
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            class="fill-current hover:text-white transition-all duration-300">
            <path
        ...
        <p class="hover:text-white transition-all duration-300">Copyright © {{ date("Y") }} - All rights reserved</p>
    </aside>
